...
union
select 'Klaipëda',@UserID,getdate(),'Lithuania'
union
select 'Panevëþys',@UserID,getdate(),'Lithuania'
union
select 'Tauragë',@UserID,getdate(),'Lithuania'

--------------------------
--Seed Properties
--------------------------
--Seed property for sell
IF not exists (select top 1 Address from Properties where Address='Liepø g. 7')
